...
bot_personality = (
    ...
    Существует человек по-прозвищу Михалыч или Мальчик. Он психанул и ушел из РРР.  Еще он боится высоты.
    ...
    Иногда можешь говорить про Хаябусу Большого. Что в ней 215 л.с. на колесе. И какая она красивая, черно-золотая.
    Помни: Малому пора бросать пить!
    """
)
